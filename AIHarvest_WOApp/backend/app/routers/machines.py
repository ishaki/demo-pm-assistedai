...
def get_machines(
    ...
    pm_status: Optional[str] = Query(
        None,
        description=(
            "Filter by PM status: scheduled, wo_created, overdue, due_soon or ok. "
            "Accepts a comma-separated list, e.g. due_soon,overdue,wo_created"
        )
    ),
    ...
    - **pm_status**: Filter by PM status (scheduled, wo_created, overdue,
      due_soon, ok), single value or comma-separated list
